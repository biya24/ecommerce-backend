...
const { verifyEmail, getUsers, promoteUser, demoteUserToCustomer , deleteUser, registerUser, loginUser, getUserProfile, updateUserProfile } = require('../controllers/userController');
